object frmCOFINSNT: TfrmCOFINSNT
  Left = 580
  Top = 250
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = 'COFINS N'#227'o Tributado'
  ClientHeight = 57
  ClientWidth = 257
  Color = clBtnFace
  ...
  object pnlCOFINSNT: TPanel
    ...
    object cbCSTCOFINSNT: TComboBox
      Left = 24
      Top = 24
      Width = 145
      Height = 21
      ...
      Items.Strings = (
        ...
        'Opera'#231#227'o Isenta da Contribui'#231#227'o'
    ...
    object btnEnviarCOFINSNT: TButton
      Left = 181
      Top = 22
      Width = 75
      Height = 25
      Caption = 'Gravar'
      TabOrder = 1
      OnClick = btnEnviarCOFINSNTClick
    end
  end
end
