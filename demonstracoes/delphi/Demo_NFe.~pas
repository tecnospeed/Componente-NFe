...
uses
  ...
  ComCtrls, XPMan, spdNFeUtils, jpeg, spdNFeValidadorClientAdapter, OleCtrls, Contnrs;
...
begin
  ...
  spdNFeDataSets.VersaoEsquema := pl_010b;
...
begin
   spdNFeDataSets.VersaoEsquema := pl_010b;
   spdNFeDataSets.XMLDicionario := spdNFe.DiretorioTemplates + 'Conversor\NFeDataSets.xml';
   spdNFeDataSets := spdNFe.ConverteXmlParaDataSet(mmXml.Text,pl_010b);
...
begin
  if mmXml.Text <> '' then
  begin
    mmXml.Text := spdNFe.ConverterLoteParaXml(mmXml.Text,lkTXTDataSet,pl_010b);
  end
  else
  CarregarArquivo;
...
procedure TDemo_NFe_Form.btnGerarDsReformaClick(Sender: TObject);
begin
  edtNumRec.clear;
  edtNumProt.clear;
  _NumeroLote := '1';
  _NumeroSerie := InputBox('NF-e', 'Insira o Número da Série:', '570');
  _NumeroNF := InputBox('NF-e', 'Insira o Número da Nota: ', '105');
  _CodigoNota := InputBox('NF-e', 'Insira o Código da Nota: ', '00000001');
  spdNFe.VersaoManual := vm60;
  spdNFeDataSets.VersaoEsquema := pl_010b;
  ...
  spdNFeDataSets.Campo('serie_B07').value := _NumeroSerie;
  spdNFeDataSets.Campo('nNF_B08').value := _NumeroNF;
  spdNFeDataSets.Campo('dhEMI_B09').value := '2025-08-11T08:46:00-03:00';
  spdNFeDataSets.Campo('tpNF_B11').value := '1';
  spdNFeDataSets.Campo('IDDEST_B11A').value := '2';
  spdNFeDataSets.Campo('cMunFG_B12').value := '4115200';
  spdNFeDataSets.Campo('cMunFGIBS_B12a').value := '4115200';
  spdNFeDataSets.Campo('tpImp_B21').value := '1';
  spdNFeDataSets.Campo('tpEmis_B22').value := '1';
  spdNFeDataSets.Campo('cDV_B23').value := '8';
  spdNFeDataSets.Campo('tpAmb_B24').value := '2';
  spdNFeDataSets.Campo('finNFe_B25').value := '1';
  spdNFeDataSets.Campo('tpNFDebito_B25_1').value := '01';
  spdNFeDataSets.Campo('tpNFCredito_B25_2').value := '01';
  spdNFeDataSets.Campo('INDFINAL_B25A').value := '1';
  spdNFeDataSets.Campo('INDPRES_B25B').value := '1';
  spdNFeDataSets.Campo('indIntermed_b25c').value := '0';
  spdNFeDataSets.Campo('procEmi_B26').value := '0';
  spdNFeDataSets.Campo('verProc_B27').value := '5';

  spdNFeDataSets.Campo('tpEnteGov_B32').value := '1';
  spdNFeDataSets.Campo('pRedutor_B33').value := '10.00';
  spdNFeDataSets.Campo('tpOperGov_B34').value := '1';

  spdNFeDataSets.IncluirPart('GPAGANTECIPADO');
  spdNFeDataSets.Campo('refNFe_BB02').value := '11111111111111111111111111111111111111111111';
  spdNFeDataSets.SalvarPart('GPAGANTECIPADO');

  spdNFeDataSets.Campo('CNPJ_C02').value := '29062609000177';
  spdNFeDataSets.Campo('xNome_C03').value := 'TECNOSPEED NEGOCIOS LTDA';
  spdNFeDataSets.Campo('xFant_C04').value := 'TECNOSPEED NEGOCIOS LTDA';
  spdNFeDataSets.Campo('xLgr_C06').value := 'RUA DO POVO';
  spdNFeDataSets.Campo('nro_C07').value := '711';
  ...
  spdNFeDataSets.Campo('xMun_C11').value := 'Maringa';
  spdNFeDataSets.Campo('UF_C12').value := 'PR';
  spdNFeDataSets.Campo('CEP_C13').value := '87053025';
  spdNFeDataSets.Campo('cPais_C14').value := '1058';
  spdNFeDataSets.Campo('xPais_C15').value := 'BRASIL';
  spdNFeDataSets.Campo('fone_C16').value := '4432222222';
  spdNFeDataSets.Campo('IE_C17').value := '9098793965';
  spdNFeDataSets.Campo('CRT_C21').value := '3';

  spdNFeDataSets.Campo('CPF_E03').value := '17407044104';
  spdNFeDataSets.Campo('xNome_E04').value := 'NF-E EMITIDA EM AMBIENTE DE HOMOLOGACAO - SEM VALOR FISCAL';
  spdNFeDataSets.Campo('xLgr_E06').value := 'RODOVIA MT 020, S/N';
  spdNFeDataSets.Campo('nro_E07').value := '897';
  spdNFeDataSets.Campo('xBairro_E09').value := 'ZONA RURAL';
  spdNFeDataSets.Campo('cMun_E10').value := '5102686';
  spdNFeDataSets.Campo('xMun_E11').value := 'Campos de Julio';
  spdNFeDataSets.Campo('UF_E12').value := 'MT';
  spdNFeDataSets.Campo('CEP_E13').value := '78860000';
  spdNFeDataSets.Campo('cPais_E14').value := '1058';
  spdNFeDataSets.Campo('xPais_E15').value := 'BRASIL';
  spdNFeDataSets.Campo('fone_E16').value := '65999664440';
  spdNFeDataSets.Campo('INDIEDEST_E16A').value := '1';
  spdNFeDataSets.Campo('IE_E17').value := '134949404';
  spdNFeDataSets.Campo('email_e19').value := 'gabrie.cunha@tecnospeed.com.br';

  spdNFeDataSets.IncluirItem;
  spdNFeDataSets.Campo('nItem_H02').value := '1';
  spdNFeDataSets.Campo('cProd_I02').value := '0999';
  spdNFeDataSets.Campo('cEAN_I03').value := 'SEM GTIN';
  spdNFeDataSets.Campo('cBarra_I03a').value := '11111111111111111111';
  spdNFeDataSets.Campo('xProd_I04').value := 'CHAVE Teste';
  spdNFeDataSets.Campo('NCM_I05').value := '00000000';
  spdNFeDataSets.Campo('CEST_I05c').value := '0123456';
  spdNFeDataSets.Campo('indEscala_I05d').value := 'S';
  spdNFeDataSets.Campo('CFOP_I08').value := '6102';
  spdNFeDataSets.Campo('uCom_I09').value := 'CX';
  spdNFeDataSets.Campo('qCom_I10').value := '1';
  spdNFeDataSets.Campo('vUnCom_I10a').value := '10.00';
  spdNFeDataSets.Campo('vProd_I11').value := '10.00';
  spdNFeDataSets.Campo('cEANTrib_I12').value := 'SEM GTIN';
  spdNFeDataSets.Campo('uTrib_I13').value := 'CX';
  spdNFeDataSets.Campo('qTrib_I14').value := '1';
  spdNFeDataSets.Campo('vUnTrib_I14a').value := '10.00';
  spdNFeDataSets.Campo('indTot_I17b').value := '1';
  spdNFeDataSets.Campo('xPed_I60').value := '123456789123456';
  

  spdNFeDataSets.Campo('orig_N11').value := '0';
  spdNFeDataSets.Campo('CST_N12').value := '90';
  spdNFeDataSets.Campo('modBC_N13').value := '0';
  spdNFeDataSets.Campo('vBC_N15').value := '10.00';
  spdNFeDataSets.Campo('pICMS_N16').value := '7.00';
  spdNFeDataSets.Campo('vICMS_N17').value := '0.70';
  spdNFeDataSets.Campo('modBCST_N18').value := '0';
  spdNFeDataSets.Campo('vBCST_N21').value := '10.00';
  spdNFeDataSets.Campo('pICMSST_N22').value := '7.00';
  spdNFeDataSets.Campo('vICMSST_N23').value := '0.70';
  ...
  spdNFeDataSets.Campo('CST_UB13').value := '001';
  spdNFeDataSets.Campo('cClassTrib_UB14').value := '000001';

  spdNFeDataSets.Campo('vBC_UB16').value := '0.00';

  spdNFeDataSets.Campo('pIBSUF_UB18').value := '0.00';

  spdNFeDataSets.Campo('pDif_UB22').value := '0.00';
  spdNFeDataSets.Campo('vDif_UB23').value := '0.00';

  spdNFeDataSets.Campo('vDevTrib_UB25').value := '0.00';

  spdNFeDataSets.Campo('pRedAliq_UB27').value := '0.00';
  spdNFeDataSets.Campo('pAliqEfet_UB28').value := '0.00';

  spdNFeDataSets.Campo('vIBSUF_UB35').value := '0.00';

  spdNFeDataSets.Campo('pIBSMun_UB37').value := '0.00';

  spdNFeDataSets.Campo('pDif_UB41').value := '0.00';
  spdNFeDataSets.Campo('vDif_UB42').value := '0.00';

  spdNFeDataSets.Campo('vDevTrib_UB44').value := '0.00';

  spdNFeDataSets.Campo('pRedAliq_UB46').value := '0.00';
  spdNFeDataSets.Campo('pAliqEfet_UB47').value := '0.00';

  spdNFeDataSets.Campo('vIBSMun_UB54').value := '0.00';

  spdNFeDataSets.Campo('pCBS_UB56').value := '0.00';

  spdNFeDataSets.Campo('pDif_UB60').value := '0.00';
  spdNFeDataSets.Campo('vDif_UB61').value := '0.00';

  spdNFeDataSets.Campo('vDevTrib_UB63').value := '0.00';

  spdNFeDataSets.Campo('pRedAliq_UB65').value := '0.00';
  spdNFeDataSets.Campo('pAliqEfet_UB66').value := '0.00';

  spdNFeDataSets.Campo('vCBS_UB67').value := '0.00';

  spdNFeDataSets.SalvarItem;

  spdNFeDataSets.Campo('vBC_W03').value := '10.00';
  spdNFeDataSets.Campo('vICMS_W04').value := '0.70';
  spdNFeDataSets.Campo('vICMSDeson_W04a').value := '0.00';
  spdNFeDataSets.Campo('vFCPUFDest_W04c').value := '0.00';
  spdNFeDataSets.Campo('vICMSUFDest_W04e').value := '0.00';
  spdNFeDataSets.Campo('vICMSUFRemet_W04g').value := '0.00';
  spdNFeDataSets.Campo('vFCP_W04h').value := '0.00';
  spdNFeDataSets.Campo('vBCST_W05').value := '10.00';
  spdNFeDataSets.Campo('vST_W06').value := '0.70';
  spdNFeDataSets.Campo('vFCPST_W06a').value := '0.00';
  spdNFeDataSets.Campo('vFCPSTRet_W06b').value := '0.00';
  spdNFeDataSets.Campo('vProd_W07').value := '10.00';
  spdNFeDataSets.Campo('vFrete_W08').value := '0.00';
  spdNFeDataSets.Campo('vSeg_W09').value := '0.00';
  spdNFeDataSets.Campo('vDesc_W10').value := '0.00';
  spdNFeDataSets.Campo('vII_W11').value := '0.00';
  ...
  spdNFeDataSets.Campo('vCOFINS_W14').value := '0.01';
  spdNFeDataSets.Campo('vOutro_W15').value := '0.00';
  spdNFeDataSets.Campo('vNF_W16').value := '10.70';

  spdNFeDataSets.Campo('vIS_W33').value := '1.00';

  spdNFeDataSets.Campo('vBCIBSCBS_W35').value := '2.00';

  spdNFeDataSets.Campo('vDif_W38').value := '3.00';
  spdNFeDataSets.Campo('vDevTrib_W39').value := '4.00';
  spdNFeDataSets.Campo('vIBSUF_W41').value := '5.00';

  spdNFeDataSets.Campo('vDif_W43').value := '6.00';
  spdNFeDataSets.Campo('vDevTrib_W44').value := '7.00';
  spdNFeDataSets.Campo('vIBSMun_W46').value := '8.00';

  spdNFeDataSets.Campo('vIBS_W47').value := '9.00';
  spdNFeDataSets.Campo('vCredPres_W48').value := '10.00';
  spdNFeDataSets.Campo('vCredPresCondSus_W49').value := '11.00';

  spdNFeDataSets.Campo('vDif_W53').value := '14.00';
  spdNFeDataSets.Campo('vDevTrib_W54').value := '15.00';
  spdNFeDataSets.Campo('vCBS_W56').value := '16.00';
  spdNFeDataSets.Campo('vCredPres_W56a').value := '12.00';
  spdNFeDataSets.Campo('vCredPresCondSus_W56b').value := '13.00';

  spdNFeDataSets.Campo('vIBSMono_W58').value := '17.00';
  spdNFeDataSets.Campo('vCBSMono_W59').value := '18.00';
  spdNFeDataSets.Campo('vIBSMonoReten_W59a').value := '19.00';
  spdNFeDataSets.Campo('vCBSMonoReten_W59b').value := '20.00';
  spdNFeDataSets.Campo('vIBSMonoRet_W59c').value := '21.00';
  spdNFeDataSets.Campo('vCBSMonoRet_W59d').value := '22.00';

  spdNFeDataSets.Campo('vNFTot_W60').value := '23.00';
  ...
  spdNFeDataSets.Campo('tPag_YA02').value := '01';
  spdNFeDataSets.Campo('vPag_YA03').value := '10.70';

  spdNFeDataSets.Campo('infCpl_Z03').value := 'Teste com quebra';

  spdNFeDataSets.Campo('CNPJ_ZD02').value := '08187168000160';
  spdNFeDataSets.Campo('xContato_ZD04').value := 'Nome teste';
  spdNFeDataSets.Campo('email_ZD05').value := 'teste@teste.com.br';
  spdNFeDataSets.Campo('fone_ZD06').value := '4466666666';
